...
class RFB_modified_larger(nn.Module):
    def __init__(self, in_channel, out_channel):
        super(RFB_modified_larger, self).__init__()
        self.relu = nn.ReLU(True)
        self.branch0 = nn.Sequential(
            BasicConv2d(in_channel, out_channel, 1),
        )
...
class RFB_modified_larger1(nn.Module):
    def __init__(self, in_channel, out_channel):
        super(RFB_modified_larger1, self).__init__()
        self.relu = nn.ReLU(True)
        self.branch0 = nn.Sequential(
            BasicConv2d(in_channel, out_channel, 1),
        )
...
class Aggregation3(nn.Module):
    ...
    def __init__(self, channel, classes):
        ...
        self.conv_concat3 = BasicConv2d(3 * channel, 3 * channel, 3, padding=1)
        self.conv4 = BasicConv2d(3 * channel, 3 * channel, 3, padding=1)
        self.conv5 = nn.Conv2d(3 * channel, classes, 1)
...
class Aggregation4(nn.Module):
    ...
    def __init__(self, channel, classes):
        ...
        self.conv5 = nn.Conv2d(4 * channel, classes, 1)
