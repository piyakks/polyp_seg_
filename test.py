...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', type=str, default='checkpoints/sam_vit_l_0b3195.pth',
                        help='Pretrained checkpoint')
    parser.add_argument('--lora_ckpt', type=str, default='output/epoch_59.pth', help='The checkpoint from LoRA')
